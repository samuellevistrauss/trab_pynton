...
window.title(" Ciencia de Dados ")
name = tk.Label(text = "banco de dados")
...
button=tk.Button(window,text="Novo Atleta",command=getInput,bg="pink")
